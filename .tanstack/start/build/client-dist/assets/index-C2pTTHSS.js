import{o as R,q as k,x as a,y as L,D as v,a8 as p,B as O,H as Y,O as V,F as z,A as E,W as F}from"./main-CdTcIt3Q.js";import{n as l,c as _,o as j,r as b}from"./if-defined-BVolksiR.js";import{T as A,D as W}from"./index-CvYicHhv.js";import"./index-CefF-8j2.js";import"./index-BfVU_VHh.js";import"./index-dyqYgwwG.js";var N;(function(s){s.approve="approved",s.bought="bought",s.borrow="borrowed",s.burn="burnt",s.cancel="canceled",s.claim="claimed",s.deploy="deployed",s.deposit="deposited",s.execute="executed",s.mint="minted",s.receive="received",s.repay="repaid",s.send="sent",s.sell="sold",s.stake="staked",s.trade="swapped",s.unstake="unstaked",s.withdraw="withdrawn"})(N||(N={}));const U=R`
  :host > wui-flex {
    display: flex;
