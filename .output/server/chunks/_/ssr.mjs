...
import { createFileRoute, lazyRouteComponent, createRootRouteWithContext, Outlet, HeadContent, Scripts, Link, RouterProvider, createRouter as createRouter$1 } from '@tanstack/react-router';
...
import { isPlainObject, isRedirect, isNotFound, rootRouteId, trimPathLeft, joinPaths, trimPath, processRouteTree, isResolvedRedirect, getMatchedRoutes, createControlledPromise, pick, TSR_DEFERRED_PROMISE, isPlainArray, defer } from '@tanstack/router-core';
  ...
  return createServerFnStaticCache({
    getItem: async (ctx) => {
      if (typeof document === "undefined") {
        ...
        const publicUrl = "/Users/mac/code/test/bundle-hell-tss/.output/public";
        const {
          promises: fs2
...
async function loadVirtualModule(id) {
  switch (id) {
    ...
    case VIRTUAL_MODULES.startManifest:
      return await import('./_tanstack-start-manifest_v-DD73iwyy.mjs');
    case VIRTUAL_MODULES.serverFnManifest:
      return await import('./_tanstack-start-server-fn-manifest_v-CewyrpZA.mjs');
    default:
...
const appCss = "/assets/styles-B48MqHkS.css";
...
const $$splitComponentImporter$3 = () => import('./index-DhKzjnND.mjs');
const Route$3 = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component", () => Route$3.ssr)
});
const $$splitComponentImporter$2 = () => import('./demo.tanstack-query-Bn2hn6ag.mjs');
const Route$2 = createFileRoute("/demo/tanstack-query")({
...
const $$splitComponentImporter$1 = () => import('./demo.start.server-funcs-Df1TZ65F.mjs');
...
const $$splitComponentImporter = () => import('./demo.start.api-request-CklsICi6.mjs');
...
const DemoTanstackQueryRoute = Route$2.update({
...
const createRouter = () => {
  const router = routerWithQueryClient(
    ...
    {
      WrapProvider: ({ children }) => /* @__PURE__ */ jsx(WagmiProvider, { config: wagmiAdapter.wagmiConfig, children })
    }
  );
  return router;
};
