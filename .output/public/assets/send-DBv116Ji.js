import{o as f,q as w,B as I,D as x,K as H,Y as l,x as u,y as z,I as W,H as g,X as L,Z as q,G as B,F,A as M,W as Y}from"./main-CdTcIt3Q.js";import{n as d,r as c,c as m,U as b,o as K}from"./if-defined-BVolksiR.js";import"./index-CZeH0WOu.js";import"./index-CefF-8j2.js";import{e as O,n as D}from"./ref-Dkd9dBo7.js";import{n as G,s as X}from"./ConstantsUtil-Dmg8YACJ.js";import"./index-BfVU_VHh.js";import{S as Z}from"./index-CTvpE0Sk.js";import"./index-Dbrdb_Pj.js";import"./index-B956-9V4.js";import"./index-SCBrD4Br.js";import"./index-dyqYgwwG.js";import"./index-Bhd2qSOn.js";const J=f`
  :host {
    width: 100%;
    height: 100px;
...
`;var j=function(s,e,i,n){var r=arguments.length,t=r<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,i):n,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(s,e,i,n);else for(var a=s.length-1;a>=0;a--)(o=s[a])&&(t=(r<3?o(t):r>3?o(e,i,t):o(e,i))||t);return r>3&&t&&Object.defineProperty(e,i,t),t};let C=class extends w{constructor(){super(...arguments),this.inputElementRef=O(),this.disabled=!1,this.value="",this.placeholder="0"}render(){var e;return(e=this.inputElementRef)!=null&&e.value&&this.value&&(this.inputElementRef.value.value=this.value),u`<input
    ...
    /> `}dispatchInputChangeEvent(e){var n,r;const i=e.data;if(i&&((n=this.inputElementRef)!=null&&n.value))if(i===","){const t=this.inputElementRef.value.value.replace(",",".");this.inputElementRef.value.value=t,this.value=`${this.value}${t}`}else G.test(i)||(this.inputElementRef.value.value=this.value.replace(new RegExp(i.replace(X,"\\$&"),"gu"),""));this.dispatchEvent(new CustomEvent("inputChange",{detail:(r=this.inputElementRef.value)==null?void 0:r.value,bubbles:!0,composed:!0}))}};C.styles=[z,W,Q];j([d({type:Boolean})],C.prototype,"disabled",void 0);j([d({type:String})],C.prototype,"value",void 0);j([d({type:String})],C.prototype,"placeholder",void 0);C=j([m("wui-input-amount")],C);const ee=f`
  :host {
    width: 100%;
    height: 100px;
    border-radius: var(--wui-border-radius-s);
